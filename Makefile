...
# Template: app
# Command: E:\QT\5.14.2\mingw73_64\bin\qmake.exe -o Makefile compiler.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: compiler.pro E:/QT/5.14.2/mingw73_64/mkspecs/win32-g++/qmake.conf E:/QT/5.14.2/mingw73_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile compiler.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
